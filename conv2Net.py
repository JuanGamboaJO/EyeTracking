...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        # Capa 1
        self.conv1 = nn.Conv2d(1, 32, kernel_size=7, stride=1, padding=1)  # Para imágenes en escala de grises
        ...
        self.fc1 = nn.Linear(11520, 81)  # Ajusta el tamaño de entrada según la salida del aplanado
        self.dropout = nn.Dropout(0.02)
        self.dropout2 = nn.Dropout(0.2)
        self.fc2 = nn.Linear(81, 1)  # Salida final
